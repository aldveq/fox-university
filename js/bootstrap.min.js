...
! ( function( t, e ) {
	...
	'use strict'; function i( t, e ) {
	...
	}g = g && g.hasOwnProperty( 'default' ) ? g.default : g, u = u && u.hasOwnProperty( 'default' ) ? u.default : u; const e = 'transitionend'; function n( t ) {
		let e = this,
	...
	} var _ = { TRANSITION_END: 'bsTransitionEnd', getUID( t ) {
		...
		for ( const i in n ) {
			if ( Object.prototype.hasOwnProperty.call( n, i ) ) {
				const o = n[ i ],
					r = e[ i ],
					s = r && _.isElement( r ) ? 'element' : ( a = r, {}.toString.call( a ).match( /\s([a-z]+)/i )[ 1 ].toLowerCase() ); if ( ! new RegExp( o ).test( s ) ) {
	...
	} }; g.fn.emulateTransitionEnd = n, g.event.special[ _.TRANSITION_END ] = { bindType: e, delegateType: e, handle( t ) {
		...
		p = ( function() {
			function i( t ) {
				...
				const e = g.Event( h.CLOSE ); return g( t ).trigger( e ), e;
			}, t._removeElement = function( e ) {
				const n = this; if ( g( e ).removeClass( m ), g( e ).hasClass( d ) ) {
					const t = _.getTransitionDurationFromElement( e ); g( e ).one( _.TRANSITION_END, function( t ) {
		...
		P = ( function() {
			function n( t ) {
				...
				let t = ! 0,
					...
					const i = this._element.querySelector( A ); if ( i ) {
						if ( 'radio' === i.type ) {
							if ( i.checked && this._element.classList.contains( S ) ) {
								t = ! 1;
							} else {
								const o = n.querySelector( N ); o && g( o ).removeClass( S );
							}
						} if ( t ) {
		...
		lt = ( function() {
			function r( t, e ) {
			...
			} const t = r.prototype; return t.next = function() {
				...
				const e = this; this._activeElement = this._element.querySelector( tt ); const n = this._getItemIndex( this._activeElement ); if ( ! ( t > this._items.length - 1 || t < 0 ) ) {
					if ( this._isSliding ) {
						...
						} const i = n < t ? W : q; this._slide( i, this._items[ t ] );
					}
				}
			}, t.dispose = function() {
				...
				const e = this; this._config.keyboard && g( this._element ).on( Q.KEYDOWN, function( t ) {
					return e._keydown( t );
				...
				const n = t === W,
					...
					return e;
				} const s = ( o + ( t === q ? -1 : 1 ) ) % this._items.length; return -1 === s ? this._items[ this._items.length - 1 ] : this._items[ s ];
				...
				if ( this._indicatorsElement ) {
					const e = [].slice.call( this._indicatorsElement.querySelectorAll( Z ) ); g( e ).removeClass( V ); const n = this._indicatorsElement.children[ this._getItemIndex( t ) ]; n && g( n ).addClass( V );
				}
				...
				let n, i, o,
					...
					h = Boolean( this._interval ); if ( o = t === W ? ( n = X, i = $, M ) : ( n = z, i = G, K ), l && g( l ).hasClass( V ) ) {
					this._isSliding = ! 1;
				} else if ( ! this._triggerSlideEvent( l, o ).isDefaultPrevented() && s && l ) {
					this._isSliding = ! 0, h && this.pause(), this._setActiveIndicatorElement( l ); const u = g.Event( Q.SLID, { relatedTarget: l, direction: o, from: a, to: c } ); if ( g( this._element ).hasClass( Y ) ) {
						g( l ).addClass( i ), _.reflow( l ), g( s ).addClass( n ), g( l ).addClass( n ); const f = parseInt( l.getAttribute( 'data-interval' ), 10 ); this._config.interval = f ? ( this._config.defaultInterval = this._config.defaultInterval || this._config.interval, f ) : this._config.defaultInterval || this._config.interval; const d = _.getTransitionDurationFromElement( s ); g( s ).one( _.TRANSITION_END, function() {
				...
				return this.each( function() {
					let t = g( this ).data( j ),
						e = l( {}, F, g( this ).data() ); 'object' === typeof i && ( e = l( {}, e, i ) ); const n = 'string' === typeof i ? i : e.slide; if ( t || ( t = new r( this, e ), g( this ).data( j, t ) ), 'number' === typeof i ) {
						t.to( i );
		...
		for ( let t = [].slice.call( document.querySelectorAll( st ) ), e = 0, n = t.length; e < n; e++ ) {
			const i = g( t[ e ] ); lt._jQueryInterface.call( i, i.data() );
		}
		...
		bt = ( function() {
			function a( e, t ) {
				...
				const t = this; if ( ! this._isTransitioning && g( this._element ).hasClass( mt ) ) {
					const e = g.Event( _t.HIDE ); if ( g( this._element ).trigger( e ), ! e.isDefaultPrevented() ) {
						const n = this._getDimension(); this._element.style[ n ] = this._element.getBoundingClientRect()[ n ] + 'px', _.reflow( this._element ), g( this._element ).addClass( vt ).removeClass( pt ).removeClass( mt ); const i = this._triggerArray.length; if ( 0 < i ) {
							for ( let o = 0; o < i; o++ ) {
								const r = this._triggerArray[ o ],
									s = _.getSelectorFromElement( r ); if ( null !== s ) {
									g( [].slice.call( document.querySelectorAll( s ) ) ).hasClass( mt ) || g( r ).addClass( yt ).attr( 'aria-expanded', ! 1 );
								}
							}
						} this.setTransitioning( ! 0 ); this._element.style[ n ] = ''; const a = _.getTransitionDurationFromElement( this._element ); g( this._element ).one( _.TRANSITION_END, function() {
				...
				let t,
					n = this; _.isElement( this._config.parent ) ? ( t = this._config.parent, 'undefined' !== typeof this._config.parent.jquery && ( t = this._config.parent[ 0 ] ) ) : t = document.querySelector( this._config.parent ); const e = '[data-toggle="collapse"][data-parent="' + this._config.parent + '"]',
					i = [].slice.call( t.querySelectorAll( e ) ); return g( i ).each( function( t, e ) {
					n._addAriaAndCollapsedClass( a._getTargetFromElement( e ), [ e ] );
				} ), t;
			}, t._addAriaAndCollapsedClass = function( t, e ) {
				const n = g( t ).hasClass( mt ); e.length && g( e ).toggleClass( yt, ! n ).attr( 'aria-expanded', n );
			}, a._getTargetFromElement = function( t ) {
				const e = _.getSelectorFromElement( t ); return e ? document.querySelector( e ) : null;
			...
			}, s( a, null, [ { key: 'VERSION', get() {
				return '4.3.1';
			} }, { key: 'Default', get() {
				return dt;
			} } ] ), a;
		}() ); g( document ).on( _t.CLICK_DATA_API, St, function( t ) {
		'A' === t.currentTarget.tagName && t.preventDefault(); const n = g( this ),
		...
		Jt = ( function() {
			function c( t, e ) {
					...
					const t = c._getParentFromElement( this._element ),
						...
						const n = { relatedTarget: this._element },
							...
							if ( ! this._inNavbar ) {
								...
								} let o = this._element; 'parent' === this._config.reference ? o = t : _.isElement( this._config.reference ) && ( o = this._config.reference, 'undefined' !== typeof this._config.reference.jquery && ( o = this._config.reference[ 0 ] ) ), 'scrollParent' !== this._config.boundary && g( t ).addClass( Ft ), this._popper = new u( o, this._menu, this._getPopperConfig() );
				...
				const e = this; g( this._element ).on( kt.CLICK, function( t ) {
				...
				if ( ! t || 3 !== t.which && ( 'keyup' !== t.type || 9 === t.which ) ) {
					for ( let e = [].slice.call( document.querySelectorAll( Ut ) ), n = 0, i = e.length; n < i; n++ ) {
						const o = c._getParentFromElement( e[ n ] ),
							r = g( e[ n ] ).data( Dt ),
							s = { relatedTarget: e[ n ] }; if ( t && 'click' === t.type && ( s.clickEvent = t ), r ) {
							const a = r._menu; if ( g( o ).hasClass( Lt ) && ! ( t && ( 'click' === t.type && /input|textarea/i.test( t.target.tagName ) || 'keyup' === t.type && 9 === t.which ) && g.contains( o, t.target ) ) ) {
								const l = g.Event( kt.HIDE, s ); g( o ).trigger( l ), l.isDefaultPrevented() || ( 'ontouchstart' in document.documentElement && g( document.body ).children().off( 'mouseover', null, g.noop ), e[ n ].setAttribute( 'aria-expanded', 'false' ), g( a ).removeClass( Lt ), g( o ).removeClass( Lt ).trigger( g.Event( kt.HIDDEN, s ) ) );
							}
						}
					}
				}
				...
				if ( ( /input|textarea/i.test( t.target.tagName ) ? ! ( 32 === t.which || 27 !== t.which && ( 40 !== t.which && 38 !== t.which || g( t.target ).closest( qt ).length ) ) : Ot.test( t.which ) ) && ( t.preventDefault(), t.stopPropagation(), ! this.disabled && ! g( this ).hasClass( Pt ) ) ) {
					const e = c._getParentFromElement( this ),
						...
						if ( 27 === t.which ) {
							const r = e.querySelector( Ut ); g( r ).trigger( 'focus' );
						}g( this ).trigger( 'click' );
					}
				}
			}, s( c, null, [ { key: 'VERSION', get() {
				return '4.3.1';
			} }, { key: 'Default', get() {
				return $t;
			} }, { key: 'DefaultType', get() {
		...
		ve = ( function() {
			function o( t, e ) {
			...
			} const t = o.prototype; return t.toggle = function( t ) {
				return this._isShown ? this.hide() : this.show( t );
			}, t.show = function( t ) {
				const e = this; if ( ! this._isShown && ! this._isTransitioning ) {
					g( this._element ).hasClass( he ) && ( this._isTransitioning = ! 0 ); const n = g.Event( re.SHOW, { relatedTarget: t } ); g( this._element ).trigger( n ), this._isShown || n.isDefaultPrevented() || ( this._isShown = ! 0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), g( this._element ).on( re.CLICK_DISMISS, _e, function( t ) {
						return e.hide( t );
				...
				const e = this; if ( t && t.preventDefault(), this._isShown && ! this._isTransitioning ) {
					const n = g.Event( re.HIDE ); if ( g( this._element ).trigger( n ), this._isShown && ! n.isDefaultPrevented() ) {
						this._isShown = ! 1; const i = g( this._element ).hasClass( he ); if ( i && ( this._isTransitioning = ! 0 ), this._setEscapeEvent(), this._setResizeEvent(), g( document ).off( re.FOCUSIN ), g( this._element ).removeClass( ue ), g( this._element ).off( re.CLICK_DISMISS ), g( this._dialog ).off( re.MOUSEDOWN_DISMISS ), i ) {
							const o = _.getTransitionDurationFromElement( this._element ); g( this._element ).one( _.TRANSITION_END, function( t ) {
				...
				const e = this,
					...
					if ( this._backdrop = document.createElement( 'div' ), this._backdrop.className = le, n && this._backdrop.classList.add( n ), g( this._backdrop ).appendTo( document.body ), g( this._element ).on( re.CLICK_DISMISS, function( t ) {
						...
						return void t();
					} const i = _.getTransitionDurationFromElement( this._backdrop ); g( this._backdrop ).one( _.TRANSITION_END, t ).emulateTransitionEnd( i );
				} else if ( ! this._isShown && this._backdrop ) {
					g( this._backdrop ).removeClass( ue ); const o = function() {
						e._removeBackdrop(), t && t();
					}; if ( g( this._element ).hasClass( he ) ) {
						const r = _.getTransitionDurationFromElement( this._backdrop ); g( this._backdrop ).one( _.TRANSITION_END, o ).emulateTransitionEnd( r );
					} else {
						o();
					}
				} else {
				...
				const t = [].slice.call( document.querySelectorAll( me ) ); g( t ).each( function( t, e ) {
					const n = g( e ).data( 'padding-right' ); g( e ).removeData( 'padding-right' ), e.style.paddingRight = n || '';
				} ); const e = [].slice.call( document.querySelectorAll( '' + pe ) ); g( e ).each( function( t, e ) {
					const n = g( e ).data( 'margin-right' ); 'undefined' !== typeof n && g( e ).css( 'margin-right', n ).removeData( 'margin-right' );
				} ); const n = g( document.body ).data( 'padding-right' ); g( document.body ).removeData( 'padding-right' ), document.body.style.paddingRight = n || '';
			}, t._getScrollbarWidth = function() {
				const t = document.createElement( 'div' ); t.className = ae, document.body.appendChild( t ); const e = t.getBoundingClientRect().width - t.clientWidth; return document.body.removeChild( t ), e;
		...
		let e,
			n = this,
			i = _.getSelectorFromElement( this ); i && ( e = document.querySelector( i ) ); const o = g( e ).data( te ) ? 'toggle' : l( {}, g( e ).data(), g( this ).data() ); 'A' !== this.tagName && 'AREA' !== this.tagName || t.preventDefault(); var r = g( e ).one( re.SHOW, function( t ) {
	...
	}; const ye = [ 'background', 'cite', 'href', 'itemtype', 'longdesc', 'poster', 'src', 'xlink:href' ],
		...
		if ( 0 === t.length ) {
			...
			return e( t );
				...
				const n = l[ t ],
					i = n.nodeName.toLowerCase(); if ( -1 === a.indexOf( n.nodeName.toLowerCase() ) ) {
					return n.parentNode.removeChild( n ), 'continue';
				} const o = [].slice.call( n.attributes ),
					r = [].concat( s[ '*' ] || [], s[ i ] || [] ); o.forEach( function( t ) {
					( function( t, e ) {
						const n = t.nodeName.toLowerCase(); if ( -1 !== e.indexOf( n ) ) {
		...
		Be = ( function() {
			function i( t, e ) {
				...
				const e = this; if ( 'none' === g( this.element ).css( 'display' ) ) {
					throw new Error( 'Please use show on visible elements' );
				} const t = g.Event( this.constructor.Event.SHOW ); if ( this.isWithContent() && this._isEnabled ) {
					g( this.element ).trigger( t ); const n = _.findShadowRoot( this.element ),
						i = g.contains( null !== n ? n : this.element.ownerDocument.documentElement, this.element ); if ( t.isDefaultPrevented() || ! i ) {
						return;
					} const o = this.getTipElement(),
						r = _.getUID( this.constructor.NAME ); o.setAttribute( 'id', r ), this.element.setAttribute( 'aria-describedby', r ), this.setContent(), this.config.animation && g( o ).addClass( xe ); const s = 'function' === typeof this.config.placement ? this.config.placement.call( this, o, this.element ) : this.config.placement,
						a = this._getAttachment( s ); this.addAttachmentClass( a ); const l = this._getContainer(); g( o ).data( this.constructor.DATA_KEY, this ), g.contains( this.element.ownerDocument.documentElement, this.tip ) || g( o ).appendTo( l ), g( this.element ).trigger( this.constructor.Event.INSERTED ), this._popper = new u( this.element, o, { placement: a, modifiers: { offset: this._getOffset(), flip: { behavior: this.config.fallbackPlacement }, arrow: { element: We }, preventOverflow: { boundariesElement: this.config.boundary } }, onCreate( t ) {
						t.originalPlacement !== t.placement && e._handlePopperPlacementChange( t );
					}, onUpdate( t ) {
						return e._handlePopperPlacementChange( t );
					} } ), g( o ).addClass( Fe ), 'ontouchstart' in document.documentElement && g( document.body ).children().on( 'mouseover', null, g.noop ); const c = function() {
						e.config.animation && e._fixTransition(); const t = e._hoverState; e._hoverState = null, g( e.element ).trigger( e.constructor.Event.SHOWN ), t === He && e._leave( null, e );
					}; if ( g( this.tip ).hasClass( xe ) ) {
						const h = _.getTransitionDurationFromElement( this.tip ); g( this.tip ).one( _.TRANSITION_END, c ).emulateTransitionEnd( h );
					} else {
						c();
					}
				}
				...
				const e = this,
					...
					if ( g( n ).removeClass( Fe ), 'ontouchstart' in document.documentElement && g( document.body ).children().off( 'mouseover', null, g.noop ), this._activeTrigger[ Ke ] = ! 1, this._activeTrigger[ Me ] = ! 1, this._activeTrigger[ qe ] = ! 1, g( this.tip ).hasClass( xe ) ) {
						const r = _.getTransitionDurationFromElement( n ); g( n ).one( _.TRANSITION_END, o ).emulateTransitionEnd( r );
					} else {
						o();
					} this._hoverState = '';
				}
				...
				const t = this.getTipElement(); this.setElementContent( g( t.querySelectorAll( Ue ) ), this.getTitle() ), g( t ).removeClass( xe + ' ' + Fe );
				...
				const i = this; this.config.trigger.split( ' ' ).forEach( function( t ) {
					if ( 'click' === t ) {
						...
						const e = t === qe ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
				...
				const e = g( this.element ).data(); return Object.keys( e ).forEach( function( t ) {
		...
		sn = ( function( t ) {
			let e, n; function i() {
			...
			}n = t, ( e = i ).prototype = Object.create( n.prototype ), ( e.prototype.constructor = e ).__proto__ = n; const o = i.prototype; return o.isWithContent = function() {
				...
				const t = g( this.getTipElement() ); this.setElementContent( t.find( nn ), this.getTitle() ); let e = this._getContent(); 'function' === typeof e && ( e = e.call( this.element ) ), this.setElementContent( t.find( on ), e ), t.removeClass( tn + ' ' + en );
		...
		Dn = ( function() {
			function n( t, e ) {
				const n = this; this._element = t, this._scrollElement = 'BODY' === t.tagName ? window : t, this._config = this._getConfig( e ), this._selector = this._config.target + ' ' + vn + ',' + this._config.target + ' ' + En + ',' + this._config.target + ' ' + Tn, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, g( this._scrollElement ).on( dn.SCROLL, function( t ) {
					return n._process( t );
				...
				const e = this,
					...
					let e,
						...
						const i = e.getBoundingClientRect(); if ( i.width || i.height ) {
				...
				this._activeTarget = e, this._clear(); const t = this._selector.split( ',' ).map( function( t ) {
		...
		for ( let t = [].slice.call( document.querySelectorAll( mn ) ), e = t.length; e--; ) {
			const n = g( t[ e ] ); Dn._jQueryInterface.call( n, n.data() );
		}
		...
		Kn = ( function() {
			function i( t ) {
				...
				const n = this; if ( ! ( this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && g( this._element ).hasClass( Pn ) || g( this._element ).hasClass( Ln ) ) ) {
					let t, i,
						e = g( this._element ).closest( xn )[ 0 ],
						o = _.getSelectorFromElement( this._element ); if ( e ) {
						const r = 'UL' === e.nodeName || 'OL' === e.nodeName ? Un : Fn; i = ( i = g.makeArray( g( e ).find( r ) ) )[ i.length - 1 ];
				...
				const i = this,
					...
					const a = _.getTransitionDurationFromElement( o ); g( o ).removeClass( Hn ).one( _.TRANSITION_END, s ).emulateTransitionEnd( a );
				} else {
					s();
				}
			}, t._transitionComplete = function( t, e, n ) {
				if ( e ) {
					g( e ).removeClass( Pn ); const i = g( e.parentNode ).find( Mn )[ 0 ]; i && g( i ).removeClass( Pn ), 'tab' === e.getAttribute( 'role' ) && e.setAttribute( 'aria-selected', ! 1 );
				} if ( g( t ).addClass( Pn ), 'tab' === t.getAttribute( 'role' ) && t.setAttribute( 'aria-selected', ! 0 ), _.reflow( t ), t.classList.contains( jn ) && t.classList.add( Hn ), t.parentNode && g( t.parentNode ).hasClass( kn ) ) {
					const o = g( t ).closest( Rn )[ 0 ]; if ( o ) {
						const r = [].slice.call( o.querySelectorAll( qn ) ); g( r ).addClass( Pn );
		...
		ni = ( function() {
			function i( t, e ) {
				...
				const t = this; g( this._element ).trigger( zn.SHOW ), this._config.animation && this._element.classList.add( Xn ); const e = function() {
					t._element.classList.remove( Jn ), t._element.classList.add( Gn ), g( t._element ).trigger( zn.SHOWN ), t._config.autohide && t.hide();
				}; if ( this._element.classList.remove( $n ), this._element.classList.add( Jn ), this._config.animation ) {
					const n = _.getTransitionDurationFromElement( this._element ); g( this._element ).one( _.TRANSITION_END, e ).emulateTransitionEnd( n );
				} else {
					e();
				}
			}, t.hide = function( t ) {
				const e = this; this._element.classList.contains( Gn ) && ( g( this._element ).trigger( zn.HIDE ), t ? this._close() : this._timeout = setTimeout( function() {
					e._close();
				}, this._config.delay ) );
			}, t.dispose = function() {
				...
				const t = this; g( this._element ).on( zn.CLICK_DISMISS, ei, function() {
					return t.hide( ! 0 );
				} );
			}, t._close = function() {
				const t = this,
		...
		} const t = g.fn.jquery.split( ' ' )[ 0 ].split( '.' ); if ( t[ 0 ] < 2 && t[ 1 ] < 9 || 1 === t[ 0 ] && 9 === t[ 1 ] && t[ 2 ] < 1 || 4 <= t[ 0 ] ) {
