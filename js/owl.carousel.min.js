...
! ( function( a, b, c, d ) {
	function e( b, c ) {
		...
		if ( this.enter( 'initializing' ), this.trigger( 'initialize' ), this.$element.toggleClass( this.settings.rtlClass, this.settings.rtl ), this.settings.autoWidth && ! this.is( 'pre-loading' ) ) {
			let b, c, e; b = this.$element.find( 'img' ), c = this.settings.nestedItemSelector ? '.' + this.settings.nestedItemSelector : d, e = this.$element.children( c ).width(), b.length && 0 >= e && this.preloadAutoWidthImages( b );
		...
		let b, c, d,
			e = this.settings,
			f = this._coordinates.length; if ( e.loop ) {
		...
		this.$element.off( '.owl.core' ), this.$stage.off( '.owl.core' ), a( c ).off( '.owl.core' ), this.settings.responsive !== ! 1 && ( b.clearTimeout( this.resizeTimer ), this.off( b, 'resize', this._handlers.onThrottledResize ) ); for ( const d in this._plugins ) {
		...
		const d = this.settings.rtl; switch ( b ) {
			case '<':return d ? a > c : c > a; case '>':return d ? c > a : a > c; case '>=':return d ? c >= a : a >= c; case '<=':return d ? a >= c : c >= a;
		}
	...
	var e = function( b ) {
		...
		let a, c; b.clearInterval( this._interval ); for ( a in this._handlers ) {
	...
	var e = function( b ) {
		this._core = b, this._loaded = [], this._handlers = { 'initialized.owl.carousel change.owl.carousel resized.owl.carousel': a.proxy( function( b ) {
			if ( b.namespace && this._core.settings && this._core.settings.lazyLoad && ( b.property && 'position' == b.property.name || 'initialized' == b.type ) ) {
				for ( let c = this._core.settings, e = c.center && Math.ceil( c.items / 2 ) || c.items, f = c.center && -1 * e || 0, g = ( b.property && b.property.value !== d ? b.property.value : this._core.current() ) + f, h = this._core.clones().length, i = a.proxy( function( a, b ) {
					this.load( b );
				}, this ); f++ < e; ) {
		...
		let a, b; for ( a in this.handlers ) {
	...
	var e = function( b ) {
		...
		let a, b; for ( a in this._handlers ) {
			this._core.$element.off( a, this._handlers[ a ] );
		} for ( b in Object.getOwnPropertyNames( this ) ) {
			'function' !== typeof this[ b ] && ( this[ b ] = null );
		}
	...
	var e = function( b ) {
		...
		let d, e, f,
			...
			}; return b.wrap( '<div class="owl-video-wrapper"' + g + '></div>' ), this._core.settings.lazyLoad && ( i = 'data-src', j = 'owl-lazy' ), h.length ? ( l( h.attr( i ) ), h.remove(), ! 1 ) : void ( 'youtube' === c.type ? ( f = '//img.youtube.com/vi/' + c.id + '/hqdefault.jpg', l( f ) ) : 'vimeo' === c.type ? a.ajax( { type: 'GET', url: '//vimeo.com/api/v2/video/' + c.id + '.json', jsonp: 'callback', dataType: 'jsonp', success( a ) {
			f = a[ 0 ].thumbnail_large, l( f );
		} } ) : 'vzaar' === c.type && a.ajax( { type: 'GET', url: '//vzaar.com/api/videos/' + c.id + '.json', jsonp: 'callback', dataType: 'jsonp', success( a ) {
		...
		let a, b; this._core.$element.off( 'click.owl.video' ); for ( a in this._handlers ) {
			this._core.$element.off( a, this._handlers[ a ] );
		} for ( b in Object.getOwnPropertyNames( this ) ) {
			'function' !== typeof this[ b ] && ( this[ b ] = null );
		}
	...
	var e = function( b ) {
		...
		let a, b; this.stop(); for ( a in this._handlers ) {
			this._core.$element.off( a, this._handlers[ a ] );
		} for ( b in Object.getOwnPropertyNames( this ) ) {
			'function' !== typeof this[ b ] && ( this[ b ] = null );
		}
	...
	'use strict'; var e = function( b ) {
		...
		let a, b, c, d; for ( a in this._handlers ) {
	...
	'use strict'; var e = function( c ) {
		this._core = c, this._hashes = {}, this.$element = this._core.$element, this._handlers = { 'initialized.owl.carousel': a.proxy( function( c ) {
			...
			if ( c.namespace && 'position' === c.property.name ) {
				const d = this._core.items( this._core.relative( this._core.current() ) ),
		...
		let c, d; a( b ).off( 'hashchange.owl.navigation' ); for ( c in this._handlers ) {
