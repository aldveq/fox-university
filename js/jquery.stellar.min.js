...
! ( function( a, b, c, d ) {
	function e( b, c ) {
		...
		g = { scrollProperty: 'scroll', positionProperty: 'position', horizontalScrolling: ! 0, verticalScrolling: ! 0, horizontalOffset: 0, verticalOffset: 0, responsive: ! 1, parallaxBackgrounds: ! 0, parallaxElements: ! 0, hideDistantElements: ! 0, hideElement( a ) {
			a.hide();
		}, showElement( a ) {
			a.show();
		} },
		h = { scroll: { getLeft( a ) {
			...
			const b = getComputedStyle( a[ 0 ] )[ k ]; return 'none' !== b ? -1 * parseInt( b.match( /(-?[0-9]+)/g )[ 4 ], 10 ) : 0;
		}, getTop( a ) {
			const b = getComputedStyle( a[ 0 ] )[ k ]; return 'none' !== b ? -1 * parseInt( b.match( /(-?[0-9]+)/g )[ 5 ], 10 ) : 0;
		} } },
		i = { position: { setLeft( a, b ) {
			a.css( 'left', b );
		}, setTop( a, b ) {
			a.css( 'top', b );
		} }, transform: { setPosition( a, b, c, d, e ) {
		...
		{var b = this; this._getScrollLeft(), this._getScrollTop();} if ( this.particles !== d ) {
			...
			let c, e, f, g, h, i, j, k, l,
				...
				const b = a( this ); return b.data( 'stellar-offset-parent' ) === ! 0 ? ( n = p, o = q, j = b, ! 1 ) : ( p += b.position().left, void ( q += b.position().top ) );
		...
		let b,
			...
			let b, g, h, i, j, k, l,
				...
				const b = a( this ); return b.data( 'stellar-offset-parent' ) === ! 0 ? ( q = s, r = t, l = b, ! 1 ) : ( s += b.position().left, void ( t += b.position().top ) );
		...
		let a, b, c, d, e; for ( e = this.particles.length - 1; e >= 0; e-- ) {
		...
		const a = this; this._animationLoop = function() {
			o( a._animationLoop ), a._repositionElements();
		}, this._animationLoop();
	} }, a.fn[ f ] = function( b ) {
		const c = arguments; return b === d || 'object' === typeof b ? this.each( function() {
			a.data( this, 'plugin_' + f ) || a.data( this, 'plugin_' + f, new e( this, b ) );
		} ) : 'string' === typeof b && '_' !== b[ 0 ] && 'init' !== b ? this.each( function() {
			const d = a.data( this, 'plugin_' + f ); d instanceof e && 'function' === typeof d[ b ] && d[ b ].apply( d, Array.prototype.slice.call( c, 1 ) ), 'destroy' === b && a.data( this, 'plugin_' + f, null );
		} ) : void 0;
	}, a[ f ] = function() {
		const c = a( b ); return c.stellar.apply( c, Array.prototype.slice.call( arguments, 0 ) );
