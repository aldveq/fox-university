 ...
 */( function( e, t ) {
	...
	'use strict'; function e( e ) {
		...
		if ( 1 !== e.nodeType ) {
			return [];
		} const o = window.getComputedStyle( e, null ); return t ? o[ t ] : o;
	} function o( e ) {
		...
		const t = e.nodeName; return 'BODY' !== t && ( 'HTML' === t || r( e.firstElementChild ) === e );
	} function s( e ) {
		...
		if ( ! e || ! e.nodeType || ! t || ! t.nodeType ) {
			...
			i = o ? e : t,
			n = o ? t : e,
			a = document.createRange(); a.setStart( i, 0 ), a.setEnd( n, 0 ); const f = a.commonAncestorContainer; if ( e !== f && t !== f || i.contains( n ) ) {
			return p( f ) ? f : r( f );
		} const l = s( e ); return l.host ? d( l.host, t ) : d( e, s( t ).host );
	} function a( e ) {
		...
		let o = {}; if ( ie() ) {
			...
			const g = t( e ); f -= l( g, 'x' ), m -= l( g, 'y' ), r.width -= f, r.height -= m;
		} return c( r );
	} function u( e, o ) {
		let i = ie(),
			r = 'HTML' === o.nodeName,
		...
		const i = e.nodeName; return 'BODY' === i || 'HTML' === i ? ! 1 : 'fixed' === t( e, 'position' ) || y( o( e ) );
	} function w( e, t, i, r ) {
		let p = { top: 0, left: 0 },
			s = d( e, t ); if ( 'viewport' === r ) {
			p = b( s );
		} else {
			let a; 'scrollParent' === r ? ( a = n( o( e ) ), 'BODY' === a.nodeName && ( a = window.document.documentElement ) ) : 'window' === r ? a = window.document.documentElement : a = r; const f = u( a, s ); if ( 'HTML' === a.nodeName && ! y( s ) ) {
				const l = h(),
					m = l.height,
		...
		const r = 5 < arguments.length && void 0 !== arguments[ 5 ] ? arguments[ 5 ] : 0; if ( -1 === e.indexOf( 'auto' ) ) {
			return e;
		} const p = w( o, i, r, n ),
		...
		const n = void 0 === i ? t : t.slice( 0, C( t, 'name', i ) ); return n.forEach( function( t ) {
			t.function && console.warn( '`modifier.function` is deprecated, use `modifier.fn`!' ); const i = t.function || t.fn; t.enabled && e( i ) && ( o.offsets.popper = c( o.offsets.popper ), o.offsets.reference = c( o.offsets.reference ), o = i( o, t ) );
		} ), o;
	} function k() {
		...
		for ( let t = [ ! 1, 'ms', 'Webkit', 'Moz', 'O' ], o = e.charAt( 0 ).toUpperCase() + e.slice( 1 ), n = 0; n < t.length - 1; n++ ) {
			const i = t[ n ],
				r = i ? '' + i + o : e; if ( 'undefined' !== typeof window.document.body.style[ r ] ) {
				return r;
			}
		} return null;
	} function D() {
		...
		o.updateBound = i, window.addEventListener( 'resize', o.updateBound, { passive: ! 0 } ); const r = n( e ); return H( r, 'scroll', o.updateBound, o.scrollParents ), o.scrollElement = r, o.eventsEnabled = ! 0, o;
	} function A() {
		...
		Object.keys( t ).forEach( function( o ) {
			let i = ''; -1 !== [ 'width', 'height', 'top', 'right', 'bottom', 'left' ].indexOf( o ) && R( t[ o ] ) && ( i = 'px' ), e.style[ o ] = t[ o ] + i;
		} );
	} function Y( e, t ) {
		Object.keys( t ).forEach( function( o ) {
			const i = t[ o ]; ! 1 === i ? e.removeAttribute( o ) : e.setAttribute( o, t[ o ] );
		} );
	} function F( e, t, o ) {
		const i = T( e, function( e ) {
		...
		const n = e.match( /((?:\-|\+)?\d*\.?\d*)(.*)/ ),
			...
			} const d = c( s ); return d[ t ] / 100 * r;
		} if ( 'vh' === p || 'vw' === p ) {
			let a; return a = 'vh' === p ? _( document.documentElement.clientHeight, window.innerHeight || 0 ) : _( document.documentElement.clientWidth, window.innerWidth || 0 ), a / 100 * r;
		} return r;
	} function G( e, t, o, i ) {
		const n = [ 0, 0 ],
			...
			s = p.indexOf( T( p, function( e ) {
				return -1 !== e.search( /,|\s/ );
			} ) ); p[ s ] && -1 === p[ s ].indexOf( ',' ) && console.warn( 'Offsets separated by white space(s) are deprecated, use a comma (,) instead.' ); let d = /\s*,\s*|\s+/,
		...
		le = ( function() {
			function t( o, i ) {
				...
				} ), this.update(); const p = this.options.eventsEnabled; p && this.enableEventListeners(), this.state.eventsEnabled = p;
			} return re( t, [ { key: 'update', value() {
				return k.call( this );
			} }, { key: 'destroy', value() {
				return D.call( this );
			} }, { key: 'enableEventListeners', value() {
				return A.call( this );
			} }, { key: 'disableEventListeners', value() {
				return I.call( this );
			} } ] ), t;
		}() ); return le.Utils = ( 'undefined' === typeof window ? global : window ).PopperUtils, le.placements = de, le.Defaults = { placement: 'bottom', eventsEnabled: ! 0, removeOnDestroy: ! 1, onCreate() {}, onUpdate() {}, modifiers: { shift: { order: 100, enabled: ! 0, fn( e ) {
		const t = e.placement,
			o = t.split( '-' )[ 0 ],
			i = t.split( '-' )[ 1 ]; if ( i ) {
			const n = e.offsets,
	...
	} }, offset: { order: 200, enabled: ! 0, fn( e, t ) {
		let o,
			i = t.offset,
			n = e.placement,
			r = e.offsets,
	...
	}, offset: 0 }, preventOverflow: { order: 300, enabled: ! 0, fn( e, t ) {
		let o = t.boundariesElement || r( e.instance.popper ); e.instance.reference === o && ( o = r( o ) ); const i = w( e.instance.popper, e.instance.reference, t.padding, o ); t.boundaries = i; let n = t.priority,
			p = e.offsets.popper,
			s = { primary( e ) {
				let o = p[ e ]; return p[ e ] < i[ e ] && ! t.escapeWithReference && ( o = _( p[ e ], i[ e ] ) ), pe( {}, e, o );
			}, secondary( e ) {
				let o = 'right' === e ? 'left' : 'top',
					n = p[ o ]; return p[ e ] > i[ e ] && ! t.escapeWithReference && ( n = z( p[ o ], i[ e ] - ( 'right' === e ? p.width : p.height ) ) ), pe( {}, o, n );
			} }; return n.forEach( function( e ) {
			const t = -1 === [ 'left', 'top' ].indexOf( e ) ? 'secondary' : 'primary'; p = se( {}, p, s[ t ]( e ) );
		} ), e.offsets.popper = p, e;
	}, priority: [ 'left', 'right', 'top', 'bottom' ], padding: 5, boundariesElement: 'scrollParent' }, keepTogether: { order: 400, enabled: ! 0, fn( e ) {
		const t = e.offsets,
			o = t.popper,
			i = t.reference,
	...
	} }, arrow: { order: 500, enabled: ! 0, fn( e, t ) {
		if ( ! F( e.instance.modifiers, 'arrow', 'keepTogether' ) ) {
			return e;
		} let o = t.element; if ( 'string' === typeof o ) {
			...
			f = s ? 'left' : 'top',
			l = s ? 'bottom' : 'right',
			m = O( o )[ d ]; p[ l ] - m < r[ a ] && ( e.offsets.popper[ a ] -= r[ a ] - ( p[ l ] - m ) ), p[ a ] + m > r[ l ] && ( e.offsets.popper[ a ] += p[ a ] + m - r[ l ] ); let h = p[ a ] + p[ d ] / 2 - m / 2,
	...
	}, element: '[x-arrow]' }, flip: { order: 600, enabled: ! 0, fn( e, t ) {
		if ( W( e.instance.modifiers, 'inner' ) ) {
			...
			p = []; switch ( t.behavior ) {
			case fe.FLIP:p = [ i, n ]; break; case fe.CLOCKWISE:p = K( i ); break; case fe.COUNTERCLOCKWISE:p = K( i, ! 0 ); break; default:p = t.behavior;
		} return p.forEach( function( s, d ) {
			if ( i !== s || p.length === d + 1 ) {
				return e;
			} i = e.placement.split( '-' )[ 0 ], n = L( i ); const a = e.offsets.popper,
	...
	}, behavior: 'flip', padding: 5, boundariesElement: 'viewport' }, inner: { order: 700, enabled: ! 1, fn( e ) {
		const t = e.placement,
			o = t.split( '-' )[ 0 ],
			i = e.offsets,
			n = i.popper,
	...
	} }, computeStyle: { order: 850, enabled: ! 0, fn( e, t ) {
		const o = t.x,
			i = t.y,
			n = e.offsets.popper,
			p = T( e.instance.modifiers, function( e ) {
				return 'applyStyle' === e.name;
			} ).gpuAcceleration; void 0 !== p && console.warn( 'WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!' ); let s, d,
			...
			b = B( 'transform' ); if ( d = 'bottom' == c ? -l.height + h.bottom : h.top, s = 'right' == u ? -l.width + h.right : h.left, a && b ) {
		...
		} const v = { 'x-placement': e.placement }; return e.attributes = se( {}, v, e.attributes ), e.styles = se( {}, m, e.styles ), e;
	}, gpuAcceleration: ! 0, x: 'bottom', y: 'right' }, applyStyle: { order: 900, enabled: ! 0, fn( e ) {
